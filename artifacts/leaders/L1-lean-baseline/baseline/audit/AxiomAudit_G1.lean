...
end L1BaselineAuditG1

open L1BaselineAuditG1 in
run_cmd do
  let env ← getEnv
  ...
  IO.println s!"L1SUM\tpartition\tG1"
  ...
  if ok then
    ...
    throwError "L1 baseline axiom audit G1 FAILED (unexpected={nUnexpected}, collect_fail={nCollectFail}, sorry={nSorry}, unsafe={nUnsafe}, native={nNative}, expected_seen={nExpectedSeen}/{expectedBad.size})"
