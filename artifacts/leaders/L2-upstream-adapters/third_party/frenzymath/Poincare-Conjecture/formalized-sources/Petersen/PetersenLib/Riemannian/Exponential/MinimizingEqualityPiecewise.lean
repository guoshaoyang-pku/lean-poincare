/- Petersen's own Riemannian infrastructure.
   Originally derived from the DoCarmo project's `DoCarmoLib/Riemannian/Exponential/MinimizingEqualityPiecewise.lean`; it is maintained
   here independently and is engineering support, not a blueprint node. -/
import PetersenLib.Riemannian.Exponential.MinimizingEquality
...
import PetersenLib.Riemannian.Exponential.MinimizingPathPiecewise
