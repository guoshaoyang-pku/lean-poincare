/- Petersen's own Riemannian infrastructure.
   Originally derived from the DoCarmo project's `DoCarmoLib/Riemannian/Exponential/MovingBaseRayODE.lean`; it is maintained
...
import PetersenLib.Riemannian.Geodesic.FlowHomogeneity
