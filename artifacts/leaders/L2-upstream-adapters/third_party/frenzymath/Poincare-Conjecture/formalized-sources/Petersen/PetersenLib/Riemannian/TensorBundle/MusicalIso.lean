/- Petersen's own Riemannian infrastructure.
   Originally derived from the DoCarmo project's `DoCarmoLib/Riemannian/TensorBundle/MusicalIso.lean`; it is maintained
...
import PetersenLib.Riemannian.TensorBundle.SmoothOrthoFrame
