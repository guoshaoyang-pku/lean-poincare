#!/usr/bin/env python3
"""Exact replication of dispatch360.compile_gate for diagnosis (repair round 2).

Walks the worktree (excluding .lake/.git/.dshpkg), runs `lake env lean <file>`
with cwd = worktree root, records per-file exit codes + stderr tails.
"""
import json, os, subprocess, sys, time

WT = "/data3/guoshaoyang/workdir/lean_poincare/longrun/worktrees/D10-bochner-euclidean"
OUT = os.path.join(WT, "longrun", "logs", "gate_repair2.json")
