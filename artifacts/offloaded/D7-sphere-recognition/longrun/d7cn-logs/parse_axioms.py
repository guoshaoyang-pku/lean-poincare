#!/usr/bin/env python3
"""Parse the `#print axioms` output of the D7-canonical-neighborhood audit.

Reads `longrun/d7cn-logs/axioms-print.out` and writes a JSON summary of the axiom cones
...
PRINT = "longrun/d7cn-logs/axioms-print.out"
...
out = {
    "schema": "d7-canonical-neighborhood/axioms-v1",
    "source": PRINT,
