#!/usr/bin/env python3
"""Parse the `#print axioms` output of the D7-gh-compactness audit.

Reads `longrun/d7ghc-logs/axioms-print.out` and writes a JSON summary of the axiom cones
...
PRINT = "longrun/d7ghc-logs/axioms-print.out"
...
out = {
    "schema": "d7-gh-compactness/axioms-v1",
    "source": PRINT,
