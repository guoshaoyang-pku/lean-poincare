#!/usr/bin/env python3
"""Round-6 (invocation 5) forbidden-token scan, wider token set than round 5.
...
def main():
    report = {"round": 6, "invocation": 5, "tokens": [t for t, _ in TOKENS],
    ...
    with open(os.path.join(HERE, "forbidden_scan_round6.json"), "w") as f:
