...
Output: audit360/missing_cards_recheck_round11.json
"""
import datetime
import glob
import hashlib
...
OUT = os.path.join(HERE, "missing_cards_recheck_round11.json")
...
def main():
    ...
    out = {"schema": "a3-missing-cards-recheck-v1", "round": 11, "checked_at": now,
           "cards": {}}
