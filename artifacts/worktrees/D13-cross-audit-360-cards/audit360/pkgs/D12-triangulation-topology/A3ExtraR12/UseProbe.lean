...
def a3r12Queries : List (String × String × String) := [
  ...
  ("simplexHomeoBoundaryConeStd", "simplexHomeoBoundaryCone", "C8-node9b literal radial boundary-cone form"),
  ("alexanderHomeo_sphereToDisk", "alexanderHomeo", "C8-node14 Alexander trick boundary restriction"),
  ("alexanderHomeo_eq_refl_iff", "alexanderHomeo", "C8-node14 Alexander trick nondegeneracy"),
  ...
  ("sphereThreeSuspension", "suspQuotHomeoSphere", "C8-node78 suspension realization consumed by the S3 suspension target"),
  ("hemisphere_charts_agree", "lowerHemisphereHomeoDisk", "C8-node10 lower-hemisphere chart compatibility consumes the disk homeomorphism"),
  ("sphereOfTwoDisks_hemisphere_instance", "lowerHemisphereHomeoDisk", "C8-node13a non-vacuity instance consumes the lower-hemisphere chart"),
  ("sphereThreeTarget_cover_isHomeo", "coveringOfSimplyConnectedIsHomeo", "C8-node5 S3 recognition target consumes the covering lemma"),
]
