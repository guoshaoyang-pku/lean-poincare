#!/bin/bash
# D13-cross-audit-360-cards round-3 re-verification sweep.
...
# negative control and the A3 D2/D3 counterexample probe.  Logs to audit360/logs-round3/.
set -u
BASE=/data3/guoshaoyang/workdir/lean_poincare/longrun/worktrees/D13-cross-audit-360-cards
LOG="$BASE/audit360/logs-round3"
...
for CARD in $CARDS; do
  ...
  {
    echo "### round3 card=$CARD cwd=$PKG at $(date -Is)"
  ...
  {
    echo "### round3 probe $CARD at $(date -Is)"
