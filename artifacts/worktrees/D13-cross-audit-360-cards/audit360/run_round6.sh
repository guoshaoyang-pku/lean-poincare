#!/bin/bash
# D13-cross-audit-360-cards round-6 (invocation 5) re-verification sweep.
...
# the A3 D2/D3 counterexample probe.  Logs to audit360/logs-round6/.
set -u
BASE=/data3/guoshaoyang/workdir/lean_poincare/longrun/worktrees/D13-cross-audit-360-cards
LOG="$BASE/audit360/logs-round6"
