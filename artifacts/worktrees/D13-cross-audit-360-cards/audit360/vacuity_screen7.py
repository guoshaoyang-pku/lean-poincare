...
Round 7 re-run of the round-3 vacuity screen against the round-7 probe logs.
...
LOG = os.path.join(HERE, "logs-round7")
OUT = os.path.join(HERE, "vacuity_screen7.json")
