...
`FiniteConjugateUniqueness.lean` companion notes, and the D7-namespaced consumers `Poincare.D7.HeatKernel.V1Interface`,
...
`Poincare.D7.HeatKernel.UniquenessStatus`, `Poincare.D7.ConjugateHeat.Status` and
