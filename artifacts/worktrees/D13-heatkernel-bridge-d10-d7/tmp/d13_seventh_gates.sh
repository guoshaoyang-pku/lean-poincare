#!/usr/bin/env bash
# D13-heatkernel-bridge-d10-d7: seventh-invocation gate suite.
# Usage: bash tmp/d13_seventh_gates.sh <prefix>   e.g. d13_seventh_final
set -u
PREFIX="${1:?usage: d13_seventh_gates.sh <prefix>}"
...
for f in release/Poincare/D13/HeatKernelBridge/Basic.lean \
         ...
         release/Poincare/D7/HeatKernel/StatementStatus.lean \
         release/Poincare/D7/HeatKernel/RepairStatus.lean \
         release/Poincare/D7/HeatKernel/DataStatus.lean; do
  if [ -f "$f" ]; then
