#!/usr/bin/env bash
# D13-heatkernel-bridge-d10-d7: twelfth-invocation gate suite.
# Usage: bash tmp/d13_eleventh_gates.sh <prefix>   e.g. d13_tenth_final
set -u
...
sha256sum release/Poincare/D13/HeatKernelBridge/*.lean \
  ...
  release/Poincare/D7/HeatKernel/ErgodicityStatus.lean \
...
for f in release/Poincare/D13/HeatKernelBridge/Basic.lean \
         ...
         release/Poincare/D13/HeatKernelBridge/ConjugateScalarCurvature.lean \
         release/Poincare/D13/HeatKernelBridge/AxiomAudit.lean \
         release/Poincare/D13/HeatKernelBridge/FiniteSpaceHeat.lean \
         release/Poincare/D13/HeatKernelBridge/FiniteUniqueness.lean \
         ...
         release/Poincare/D7/ConjugateHeat/Status.lean \
         release/Poincare/D7/ConjugateHeat/UniquenessStatus.lean \
         release/Poincare/D7/ConjugateHeat/ScalarCurvatureStatus.lean; do
  if [ -f "$f" ]; then
