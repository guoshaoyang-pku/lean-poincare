...
DELIVERABLES = [
    ...
    "tools/acceptance_pass2.py",
    "tools/acceptance_pass3.py",
    "tools/gs_independent_check.py",
    "tools/acceptance_pass5.py",
    "tools/acceptance_pass6.py",
    "tools/make_result_card.py",
    "tools/final_integrity_check.py",
    "evidence/acceptance-pass2.json",
    "evidence/acceptance-pass3.json",
    "evidence/gs-independent-acceptance.json",
    "evidence/acceptance-pass5.json",
    "evidence/acceptance-pass6.json",
    "tmp/independent_acceptance_probe.lean",
    "tmp/acceptance_probe_r2.lean",
    "tmp/acceptance_probe_r3.lean",
    "tmp/acceptance_probe_r3_audit.lean",
    "tmp/gs_independent_probe.lean",
    "tmp/acceptance_probe_r5.lean",
    "tmp/acceptance_probe_r6.lean",
    "tmp/mutation/poisoned_audit.lean",
    "tmp/mutation/truncated_audit.lean",
    "tmp/mutation/scan_targets/real_sorry.lean",
    "tmp/mutation/scan_targets/comment_only.lean",
