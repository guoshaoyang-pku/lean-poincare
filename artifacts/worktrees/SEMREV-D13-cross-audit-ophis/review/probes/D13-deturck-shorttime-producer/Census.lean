/-
SEMREV independent fail-closed census probe for D13-deturck-shorttime-producer.
...
import Poincare.D13.DeturckProducer.Audit
...
namespace SEMREV_D13_deturck_shorttime_producer
...
def auditedModules : List Name := [
  ...
  "Poincare.D13.DeturckProducer.Audit".toName,
  "Poincare.D13.DeturckProducer.FlatInstance".toName,
  "Poincare.D13.DeturckProducer.PicardModel".toName,
  "Poincare.D13.DeturckProducer.Reaction".toName,
  "Poincare.D13.DeturckProducer.SmoothMetric".toName,
  "Poincare.D13.DeturckProducer.SymbolMatrix".toName,
...
end SEMREV_D13_deturck_shorttime_producer

open SEMREV_D13_deturck_shorttime_producer in
run_cmd do
  let env ← getEnv
  ...
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tdeclarations\t{rows.size}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\ttheorems\t{nThm}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tpartial_defs\t{nPartial}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\topaque\t{nOpaque}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tproject_axioms\t{nAxiom}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tunsafe\t{nUnsafe}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tsorry_cones\t{nSorry}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tnative_decide_cones\t{nNative}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tunapproved_axiom_cones\t{nOther}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tcollect_failures\t{nFail}"
  IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tproof_wanted\t{nProofWanted}"
  if nAxiom + nUnsafe + nSorry + nNative + nOther + nFail + nProofWanted > 0 then
    IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tVERDICT\tFAIL"
    throwError "SEMREV: forbidden dependency found (D13-deturck-shorttime-producer)"
  else
    IO.println s!"XAUDIT\tD13-deturck-shorttime-producer\tVERDICT\tPASS"
