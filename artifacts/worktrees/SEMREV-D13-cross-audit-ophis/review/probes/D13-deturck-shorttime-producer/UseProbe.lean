/-
SEMREV independent use probe for D13-deturck-shorttime-producer (written for the SEMREV review).
...
namespace SEMREVUse_D13_deturck_shorttime_producer
...
def existsNames : List Name := [
  ...
  "Poincare.D13.DeturckProducer.PicardModel.MildClassicalOutput".toName,
  ...
  "Poincare.D13.DeturckProducer.FlatInstance.flatPicardModel".toName,
  "Poincare.D13.DeturckProducer.PicardModel.RicciDeTurckPicardModel.strictParabolic".toName]

def pairs : List (Name × Name) := [
  ("Poincare.D13.DeturckProducer.PicardModel.MildClassicalOutput".toName, "Poincare.D13.DeturckProducer.PicardModel.deTurckShortTimeExistence_of_classicalOutput".toName),
...
end SEMREVUse_D13_deturck_shorttime_producer

open SEMREVUse_D13_deturck_shorttime_producer in
run_cmd do
  let env ← getEnv
  ...
  IO.println s!"USE_DONE\tD13-deturck-shorttime-producer"
