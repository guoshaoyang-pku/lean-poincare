/-
SEMREV independent use probe for D13-heatkernel-bridge-d10-d7 (written for the SEMREV review).
...
namespace SEMREVUse_D13_heatkernel_bridge_d10_d7

def existsNames : List Name := [
  "Poincare.D7.HeatKernel.HeatKernelData".toName,
  ...
  "Poincare.D7.HeatKernel.not_heatKernelExistenceStatementV1_of_legacy_refutation".toName]
...
end SEMREVUse_D13_heatkernel_bridge_d10_d7

open SEMREVUse_D13_heatkernel_bridge_d10_d7 in
run_cmd do
  let env ← getEnv
  ...
  IO.println s!"USE_DONE\tD13-heatkernel-bridge-d10-d7"
