/-
SEMREV independent fail-closed census probe for D13-integrated-kernel-audit.
...
namespace SEMREV_D13_integrated_kernel_audit
...
end SEMREV_D13_integrated_kernel_audit

open SEMREV_D13_integrated_kernel_audit in
run_cmd do
  let env ← getEnv
  ...
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tdeclarations\t{rows.size}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\ttheorems\t{nThm}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tpartial_defs\t{nPartial}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\topaque\t{nOpaque}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tproject_axioms\t{nAxiom}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tunsafe\t{nUnsafe}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tsorry_cones\t{nSorry}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tnative_decide_cones\t{nNative}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tunapproved_axiom_cones\t{nOther}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tcollect_failures\t{nFail}"
  IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tproof_wanted\t{nProofWanted}"
  if nAxiom + nUnsafe + nSorry + nNative + nOther + nFail + nProofWanted > 0 then
    IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tVERDICT\tFAIL"
    throwError "SEMREV: forbidden dependency found (D13-integrated-kernel-audit)"
  else
    IO.println s!"XAUDIT\tD13-integrated-kernel-audit\tVERDICT\tPASS"
