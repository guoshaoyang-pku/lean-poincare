/-
SEMREV independent fail-closed census probe for D13-morgan-tian-adapter-plan.
...
namespace SEMREV_D13_morgan_tian_adapter_plan
...
def auditedModules : List Name := [
  ...
  "Poincare.D13.MorganTianAdapter.All".toName,
  "Poincare.D13.MorganTianAdapter.Audit".toName,
  "Poincare.D13.MorganTianAdapter.BishopGromov".toName,
  "Poincare.D13.MorganTianAdapter.Curvature".toName,
  "Poincare.D13.MorganTianAdapter.ExpGeodesic".toName,
  "Poincare.D13.MorganTianAdapter.LeviCivitaSmoothness".toName,
  "Poincare.D13.MorganTianAdapter.Tensoriality".toName,
...
end SEMREV_D13_morgan_tian_adapter_plan

open SEMREV_D13_morgan_tian_adapter_plan in
run_cmd do
  let env ← getEnv
  ...
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tdeclarations\t{rows.size}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\ttheorems\t{nThm}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tpartial_defs\t{nPartial}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\topaque\t{nOpaque}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tproject_axioms\t{nAxiom}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tunsafe\t{nUnsafe}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tsorry_cones\t{nSorry}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tnative_decide_cones\t{nNative}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tunapproved_axiom_cones\t{nOther}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tcollect_failures\t{nFail}"
  IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tproof_wanted\t{nProofWanted}"
  if nAxiom + nUnsafe + nSorry + nNative + nOther + nFail + nProofWanted > 0 then
    IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tVERDICT\tFAIL"
    throwError "SEMREV: forbidden dependency found (D13-morgan-tian-adapter-plan)"
  else
    IO.println s!"XAUDIT\tD13-morgan-tian-adapter-plan\tVERDICT\tPASS"
