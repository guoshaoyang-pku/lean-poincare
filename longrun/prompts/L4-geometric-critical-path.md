...
Worktree: remote worktrees/leaders/L4-geometric-critical-path
Lane: builder
Model: deepseek-flash (host credential reference only; never print or copy credentials)

Objective:
M3 geometry critical path: develop manifold volume/IBP, geodesic comparison and compactness interfaces. Require constructed measures/estimates and downstream checked use; keep chart/model versus manifold claims explicit.
...
- Write a result card under longrun/results/L4-geometric-critical-path.md and .json ending TASK_DONE or TASK_BLOCKED; this requests independent acceptance and never claims Poincare proved.

Named blockers in scope: U3, U7, U9, I4, I5
