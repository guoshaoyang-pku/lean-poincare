...
Worktree: remote worktrees/leaders/L3-analytic-critical-path
Lane: builder
Model: deepseek-flash (host credential reference only; never print or copy credentials)

Objective:
M3 analytic critical path: continue heat-domain/semigroup and parabolic/DeTurck work from D10-D13 artifacts. Produce a downstream-consumable compiled lemma or precise blocker split; finite/Euclidean results remain model.
...
- Write a result card under longrun/results/L3-analytic-critical-path.md and .json ending TASK_DONE or TASK_BLOCKED; this requests independent acceptance and never claims Poincare proved.

Named blockers in scope: U6, U8, U12
