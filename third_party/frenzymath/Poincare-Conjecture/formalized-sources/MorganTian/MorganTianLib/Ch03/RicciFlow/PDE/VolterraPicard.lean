...
This module isolates the temporal part of a short-time nonlinear construction.
The source estimates are packaged as a closed-ball Picard--Lindelof problem;
Mathlib's Banach-valued Picard theorem then supplies a genuine integral-curve
fixed point, its initial trace, and its within-derivative.  Spatial metric
regularity and positivity remain separate hypotheses in the DeTurck layer.
-/
...
The factorial estimate in Mathlib's Picard--Lindelof development makes this
