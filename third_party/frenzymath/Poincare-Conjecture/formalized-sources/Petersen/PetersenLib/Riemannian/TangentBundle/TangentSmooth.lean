/- Petersen's own Riemannian infrastructure.
   Originally derived from the DoCarmo project's `DoCarmoLib/Riemannian/TangentBundle/TangentSmooth.lean`; it is maintained
...
import PetersenLib.Riemannian.Util.Chart.FlatChartDerivs
